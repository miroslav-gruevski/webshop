...
const socialLinks = [
  { name: 'Facebook', href: 'https://www.facebook.com/ecssystems' },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/company/ecs-systems' },
  { name: 'Instagram', href: 'https://www.instagram.com/ecssystems' },
];
